...
void TMVP_mixed(type64 *F, type64 *G, type64 *Z){
    ...
    type128 X10 = m3 + m4 + (type128)(inter_common+F[3])*T1[2];
    type128 X11 = m2 - m4 + (type128)(intra_common+F[2])*T1[1];
    type128 X12 = (type128)(F[5]+intra_common)*T1[0] - m2 - m3;
    ...
    type128 X13 = m3 + m4 + (type128)(intra_common+c)*T1[2];
    type128 X14 = m2 - m4 + (type128)(intra_common+F[1])*T1[1];
    type128 X15 = (type128)(F[0]+inter_common)*T1[0] - m2 - m3;
    ...
    type128 X16 = m3 + m4 + (type128)(T1[4]+T1[3]+(2*F[4]))*T1[2];
    type128 X17 = m2 - m4 + (type128)(intra_common+T1[4])*T1[1];
    type128 X18 = (type128)(T5+intra_common)*T1[0] - m2 - m3;
